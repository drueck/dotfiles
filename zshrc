...
export PATH=$PATH:/usr/local/heroku/bin:/home/david/projects/code-generation:/home/david/programs/elixir/bin:/home/david/bin:$GOROOT/bin:$GOPATH/bin:$HOME/.exenv/bin
